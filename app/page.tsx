...
type ConversationItem = { id:string; matchId:string; anonymousCode:string; score:number; status:"active"|"cancelled"|"success_pending"|"successful"; createdAt:number; perspective:Mode; payload:Record<string,string>; reasons:string[]; risks:string[]; verifyOnMeeting:string[]; lastMessage?:string|null; messageCount:number };
